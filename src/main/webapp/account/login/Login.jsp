			...
			<div id="login" style="display: block;">
				<form action="loginAction" method="post">
					...
					<div class="form-group form-check">
						<!-- <input type="checkbox" class="form-check-input" id="exampleCheck" name="checked">
						<label class="form-check-label" for="exampleCheck">Remember Password</label>  -->
						<s:checkbox name="checked" id="exampleCheck" label="Remember Me (Do not check on public computer)"/>
					...
					<a href="/account/register" class="btn btn-success" style="margin:20px;">Register</a>
				</form>
			</div>		
